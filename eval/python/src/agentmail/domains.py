...
class Domains(BaseSDK):
        ...
        **CLI:**
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.components.CreateDomainRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    async def domains_create_async(
        self,
        *,
        domain: str,
        feedback_enabled: bool,
    ...
    async def domains_update_async(
        self,
        *,
        domain_id: str,
        feedback_enabled: Optional[bool] = None,
    ...
    async def domains_delete_async(
        self,
        *,
        domain_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        **CLI:**
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="domains_getZoneFile",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def domains_get_zone_file_async(
        self,
        *,
        domain_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def domains_verify_async(
        self,
        *,
        domain_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,

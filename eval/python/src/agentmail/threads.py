...
class Threads(BaseSDK):
    ...
    async def threads_update_async(
        self,
        *,
        thread_id: str,
        add_labels: OptionalNullable[List[str]] = UNSET,
    ...
    async def threads_delete_async(
        self,
        *,
        thread_id: str,
        permanent: OptionalNullable[bool] = UNSET,
        ...
        **CLI:**
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="threads_getAttachment",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    async def threads_get_attachment_async(
        self,
        *,
        thread_id: str,
        attachment_id: str,

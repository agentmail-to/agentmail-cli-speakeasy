...
if TYPE_CHECKING:
    from agentmail.agent import Agent
    from agentmail.apikeys import APIKeys
...
class AgentmailCli(BaseSDK):
    ...
    _sub_sdk_map = {
        ...
        "pods": ("agentmail.pods", "Pods"),
        "webhooks": ("agentmail.webhooks", "Webhooks"),
        "agent": ("agentmail.agent", "Agent"),
    ...
    def __init__(
        ...
        if callable(bearer_auth):
            ...
            security = lambda: models.components.Security(bearer_auth=bearer_auth())
        else:

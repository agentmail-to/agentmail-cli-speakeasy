...
class Lists(BaseSDK):
    ...
    ) -> models.components.ListListEntriesResponse:
        r"""List Entries
        ...
        **CLI:**
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.components.ListListEntriesResponse, http_res
            )
    ...
    def lists_create(
        ...
        **CLI:**
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.components.ListEntry, http_res)

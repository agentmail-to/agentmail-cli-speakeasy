...
<!-- UsageSnippet language="typescript" operationID="pods_drafts_list" method="get" path="/v0/pods/{pod_id}/drafts" -->
```typescript
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PodsDraftsListRequest](../../models/operations/pods-drafts-list-request.md)                                                                                        | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
<!-- UsageSnippet language="typescript" operationID="pods_drafts_get" method="get" path="/v0/pods/{pod_id}/drafts/{draft_id}" -->
```typescript
import { AgentmailCli } from "agentmail";
...
<!-- UsageSnippet language="typescript" operationID="pods_drafts_getAttachment" method="get" path="/v0/pods/{pod_id}/drafts/{draft_id}/attachments/{attachment_id}" -->
```typescript
import { AgentmailCli } from "agentmail";

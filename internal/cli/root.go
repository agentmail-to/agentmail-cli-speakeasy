...
import (
	"agentmail-cli/internal/cli/agent"
	"agentmail-cli/internal/cli/apikeys"
	...
	"agentmail-cli/internal/explorer"
...
func NewRootCommand() (*cobra.Command, error) {
	...
	if err := inboxes.InitInboxesRoot(rootCmd); err != nil {
		return nil, fmt.Errorf("init inboxes: %w", err)
	}
	if err := pods.InitPodsRoot(rootCmd); err != nil {
		return nil, fmt.Errorf("init pods: %w", err)
	}

...
func newOrganizations(rootSDK *AgentmailCli, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Organizations {
...
// ```
func (s *Organizations) OrganizationsGet(ctx context.Context, opts ...operations.Option) (*operations.OrganizationsGetResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.OrganizationsGetServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/v0/organizations")
	if err != nil {

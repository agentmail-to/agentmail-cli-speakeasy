## agentmail inboxes messages inboxes-messages-update
...
```
agentmail inboxes messages inboxes-messages-update [flags]
```

### Examples

```
  agentmail messages inboxes-messages-update --inbox-id <id> --message-id <id>
```
...
```
  ...
  -h, --help                   help for inboxes-messages-update

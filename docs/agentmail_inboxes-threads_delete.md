...
```
agentmail inboxes-threads delete [flags]
```

### Examples

```
  agentmail inboxes-threads delete --inbox-id <id> --thread-id <id>
```
...
```
  ...
  -p, --permanent string   If true, permanently delete the thread instead of moving to trash.

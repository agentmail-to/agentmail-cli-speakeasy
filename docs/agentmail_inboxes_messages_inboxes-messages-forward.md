## agentmail inboxes messages inboxes-messages-forward
...
```
agentmail inboxes messages inboxes-messages-forward [flags]
```

### Examples

```
  agentmail messages inboxes-messages-forward --inbox-id <id> --message-id <id>
```
...
```
  ...
  -h, --help                 help for inboxes-messages-forward
  ...
  -s, --subject string       Subject of message.

...
```
agentmail inboxes lists delete [flags]
```

### Examples

```
  agentmail inboxes-lists delete --inbox-id <id> --direction reply --type allow --entry <value>
```
...
```
  ...
  -e, --entry string       Email address or domain. [required]

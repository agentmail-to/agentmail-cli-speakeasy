...
```
agentmail pods-threads delete [flags]
```

### Examples

```
  agentmail pods-threads delete --pod-id <id> --thread-id <id>
```
...
```
  -h, --help               help for delete
      --permanent string   If true, permanently delete the thread instead of moving to trash.

## agentmail pods-API-keys pods-api-keys-create
...
```
agentmail pods-API-keys pods-api-keys-create [flags]
```

### Examples

```
  agentmail pods-API-keys pods-api-keys-create --pod-id <id>
```
...
```
  ...
  -h, --help                 help for pods-api-keys-create

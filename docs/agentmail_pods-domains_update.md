...
```
agentmail pods-domains update [flags]
```

### Examples

```
  agentmail pods-domains update --pod-id <id> --domain-id <id>
```
...
```
  ...
  -f, --feedback-enabled   Bounce and complaint notifications are sent to your inboxes.

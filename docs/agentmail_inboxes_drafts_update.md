...
```
agentmail inboxes drafts update [flags]
```

### Examples

```
  agentmail inboxes-drafts update --inbox-id <id> --draft-id <id>
```
...
```
  ...
  -c, --cc username@domain.com         Addresses of CC recipients. In format username@domain.com or `Display Name <username@domain.com>`.

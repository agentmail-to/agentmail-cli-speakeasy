## agentmail inboxes-API-keys inboxes-api-keys-create
...
```
agentmail inboxes-API-keys inboxes-api-keys-create [flags]
```

### Examples

```
  agentmail inboxes-API-keys inboxes-api-keys-create --inbox-id <id>
```
...
```
  ...
  -h, --help                 help for inboxes-api-keys-create

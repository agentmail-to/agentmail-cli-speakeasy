...
```
agentmail inboxes lists create [flags]
```

### Examples

```
  agentmail inboxes-lists create --inbox-id <id> --direction reply --type allow --entry <value>
```
...
```
  ...
  -e, --entry string       Email address or domain to add. [required]
  -h, --help               help for create
  -i, --inbox-id string    [required]
  -r, --reason string      Reason for adding the entry.

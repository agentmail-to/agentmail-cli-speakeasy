...
```
agentmail pods inboxes update [flags]
```

### Examples

```
  agentmail pods-inboxes update --pod-id <id> --inbox-id <id> --display-name Newton87
```
...
```
      ...
      --display-name Display Name <username@domain.com>   Display name: Display Name <username@domain.com>. [required]

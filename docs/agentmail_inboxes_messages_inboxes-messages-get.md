## agentmail inboxes messages inboxes-messages-get
...
```
agentmail inboxes messages inboxes-messages-get [flags]
```

### Examples

```
  agentmail messages inboxes-messages-get --inbox-id <id> --message-id <id>
```

### Options

```
  -h, --help                help for inboxes-messages-get

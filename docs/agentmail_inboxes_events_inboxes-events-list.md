## agentmail inboxes events inboxes-events-list
...
```
agentmail inboxes events inboxes-events-list [flags]
```

### Examples

```
  agentmail events inboxes-events-list --inbox-id <id>
```
...
```
  ...
  -h, --help                help for inboxes-events-list

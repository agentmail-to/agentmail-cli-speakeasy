...
```
agentmail inboxes-messages get-attachment [flags]
```

### Examples

```
  agentmail inboxes-messages get-attachment --inbox-id <id> --message-id <id> --attachment-id <id>
```
...
```
  ...
  -h, --help                   help for get-attachment

## agentmail inboxes messages inboxes-messages-send
...
```
agentmail inboxes messages inboxes-messages-send [flags]
```

### Examples

```
  agentmail messages inboxes-messages-send --inbox-id <id>
```
...
```
  ...
  -h, --help                 help for inboxes-messages-send

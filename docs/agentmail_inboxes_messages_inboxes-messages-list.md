## agentmail inboxes messages inboxes-messages-list
...
```
agentmail inboxes messages inboxes-messages-list [flags]
```

### Examples

```
  agentmail messages inboxes-messages-list --inbox-id <id>
```
...
```
  ...
  -h, --help                 help for inboxes-messages-list
      --inbox-id string      [required]
      --include-blocked      boolean flag
      --include-spam         boolean flag
      --include-trash        boolean flag
